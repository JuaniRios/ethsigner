import { Wallet, getBytes, hashMessage, verifyMessage, utils } from "ethers";
...
const messageBytes = u8aConcat(polimecAccountBytes, separatorBytes, projectIdBytes, separatorBytes, nonceBytes);
...
console.log("Message Bytes (Account + '-' + Project ID + '-' + Nonce):", messageHex);
